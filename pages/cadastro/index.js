...
import {validarNome, validarEmail, validarSenha, validarComfirmacaoSenha} from "../../utils/validadores"
...
export default function Cadastro() {
    ...
    const validarFormulario = () => {
        return (
            ...
            && validarEmail(email)
            && validarSenha(senha)
            && validarComfirmacaoSenha(senha, confirmacaoSenha)
        )
    }
            ...
            <div className="conteudoPaginaPublica">
                <form onSubmit={aoSubmeter}>
                    ...
                    <InputPublico
                        ...
                        exibirMensagemValidacao={confirmacaoSenha && !validarComfirmacaoSenha(senha, confirmacaoSenha)}
                    />
